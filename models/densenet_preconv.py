...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16), preconv='wide',
        ...
        self.features = nn.Sequential(OrderedDict([
            ('conv0', nn.Conv2d(out_channels, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
    ...
    def forward(self, x):
        # Apply down-convolution before Densenet
        x = self.preconv(x)
        # Propogate forward through Densenet
